...
public enum IdentityExceptionCodes {
  ...
  SESSION_REVOKED(HttpStatus.UNAUTHORIZED), SESSION_EXPIRED(HttpStatus.UNAUTHORIZED),
  INVALID_REFRESH_TOKEN(HttpStatus.UNAUTHORIZED), INVALID_RESET_TOKEN(HttpStatus.BAD_REQUEST),
