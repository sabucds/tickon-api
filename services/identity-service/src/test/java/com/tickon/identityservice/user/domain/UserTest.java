...
public class UserTest {
    ...
    public void shouldRegisterUser(){
      ...
      User registeredUser = User.forRegistration(userId, Email.from("john@example.com"), Username.from("john_doe"), "John", "Doe", new PasswordHash("hashed-password"), fixedInstant);
    ...
    public void shouldBeInstantiatedWithPersistenceData(){
      UserId userId = UserId.generate();
      User registeredUser = User.fromPersistence(userId, Email.from("john@example.com"), Username.from("john_doe"), "John", "Doe", new PasswordHash("hashed-password"), fixedInstant,fixedInstant,false, null);
